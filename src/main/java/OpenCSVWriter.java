import com.dumyproject.CSVUser;
...
public class OpenCSVWriter {
    ...
    public static void main(String[] args) throws IOException,
        ...
        try (
            ...
            myUsers.add(new CSVUser("Sundar Pichai", "sundar.pichai@gmail.com", "+1-11111111111","United States"));
            myUsers.add(new CSVUser("Satya Nadella", "satya.nadella@gmail.com", "+1-11111111111","United States"));
